        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HaberResim = table.Column<string>(nullable: true),
                    HaberBaslik = table.Column<string>(nullable: true),
                    HaberIcerik = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
